...
from .models import Pedido_Delivery,ZelleModel,PagoNacional,PaypalModel
...
#duplicar el funcionamiento de pedios para el pickup
...
def PagoMovilView(request, id):
    id = int(id)
    total = request.session.get('total')  # Asegúrate de que esto sea un valor válido
    if total is None:
